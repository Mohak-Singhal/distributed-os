...
/// Linux implementation of [`HeartbeatSampler`]. Full metrics in Phase 7.
pub struct LinuxSampler { version: String }
...
impl HeartbeatSampler for LinuxSampler {
